...
const AllProducts = ({ productData }: { productData: ProductProps[] }) => {
  ...
  return (
    <>
      ...
      <div className="grid grid-cols-6 p-3 ml-6 mr-6 ">
        {productData.map((item: ProductProps,index) => (<div key={index}>
            ...
            <Carousel
              ...
              <div className="card-body ">
                <h5 className="card-title ml-4 font-bold mt-6">
                  {item.title}{" "}
                </h5>
                ...
                <h1 className="text-xs text-gray-400 line-through ml-4">
                  Rs. {item.price + 500}
                </h1>
